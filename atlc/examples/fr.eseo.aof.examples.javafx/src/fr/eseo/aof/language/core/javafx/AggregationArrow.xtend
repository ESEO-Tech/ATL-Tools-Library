...
class AggregationArrow extends Group {
	...
	new() {
		...
		head.topLeftColor = Color.CHOCOLATE
		head.topRightColor = Color.CHOCOLATE
		head.bottomLeftColor = Color.CHOCOLATE
		head.bottomRightColor = Color.CHOCOLATE
